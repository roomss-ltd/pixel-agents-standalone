...
local ICONS = {
    ...
    ["coffee"] = [[<path class="coffee-smoke coffee-smoke-1" d="M7.1 7.1C4.2 5.2 10.1 3.8 7.4 1.6"/><path class="coffee-smoke coffee-smoke-2" d="M11 7.1C8.1 5.1 14 3.9 11.2 1.3"/><path class="coffee-smoke coffee-smoke-3" d="M14.9 7.1C12 5.2 17.8 3.8 15 1.5"/><path d="M18 8h1a4 4 0 1 1 0 8h-1"/><path d="M4 8h14v7a6 6 0 0 1-6 6H10a6 6 0 0 1-6-6Z"/><path d="M6 8h10"/>]],
